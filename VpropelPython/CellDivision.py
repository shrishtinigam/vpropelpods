...
ignore this i will remove it soon
"""
n=int(input())
print(n//10 + 1)

# dunno what is being asked in the question but this works... if the cells divide into 2 then how can there be 35 (odd) number of cells at the end.. ?